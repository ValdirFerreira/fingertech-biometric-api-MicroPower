...
Pré-requisitos
Instale o NSIS (gratuito) → https://nsis.sourceforge.io/Download
...
```
Gerar o `.exe`
Instale o NSIS → https://nsis.sourceforge.io/Download
Monte a pasta conforme estrutura acima
Clique com botão direito no `installer.nsi` → "Compile NSIS Script"
O instalador `Fingertech-BiometricAPI-Setup-v2.4.5.exe` é gerado na mesma pasta
